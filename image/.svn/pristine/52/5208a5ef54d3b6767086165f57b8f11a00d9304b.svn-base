...
<form id="orderForm" action="${base}/order/go-on-add-order.htm" method="POST">
<#list itemList as cartList>
      	<input type="hidden" id='itemId' name="itemId" value="${cartList}">
</#list>
...
<input type="hidden" id='order_id' name="id" value='${order.id?c}'>
