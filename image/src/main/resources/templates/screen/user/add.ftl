...
<div class="bjf7 p20 of">
  <div class="user of">
	    ...
	    <div class="right_title">用户管理-新建</div>
		  ...
		  <form id="userForm" method="post" class="form-horizontal">
		    <div class="row">
              ...
              <div class="col-md-11.5">
                ...
                <div class="form-group">
                	<label class="col-md-4 control-label" for="company">公司名称：</label>
                  <div class="col-md-8">
                    <input type="text" name="company" placeholder="公司名称" id="company" class="form-control">
                  </div>
                </div>
              </div>
            </div>
