...
<div class="bjf7 p20">
  <div class="user of">
	...
	<form id="queryForm" method="post" action="${base}/fileList.html" >
      ...
      <div class="right_con">
        <div>
          ...
          <div class="mt10">
          	...
          	OEM:
          	<select  id="oemSelect" value="<#if query.uploadUsername?exists>${query.uploadUsername}</#if>" style="width: 160px; padding: 4px;" >
          			<option value=""></option>          	
          			<#list uploadUsernameList as uploadUsername>
          			<option value="${uploadUsername}"  >${uploadUsername}</option>
          			</#list>
          	</select>
          	状态:
          ...
          <div class="order">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr class="tr-b">
                <td >
                	<#if order.fileType==1> <img style="width:39px;height:80px;" src="${base}/static/images/fileUpload/initial模板-01.png" />Initial价格牌（大）
                	<#elseif order.fileType==2> <img style="width:39px;height:80px;" src="${base}/static/images/fileUpload/initial模板-02.png" />Initial价格牌（小）
                	...
                	<#else>
                	<img style="width:39px;height:80px;" src="${base}/static/images/fileUpload/initial模板-04.png" />2019新合格证(小)
                	</#if>
                </td>
                <td>
                	${order.uploadTime}
                ...
                <td>
                	<input type="button" id="read" style="width:68px;height:23px;font-size:15px; border:1px solid #d90b19;text-align:center; margin:auto; line-height:23px; color:#d90b19; margin-bottom:10px;background: white;" onclick="toInfo(${order.id},${order.fileType},${order.status})" value="查看" >
                </td>
        ...
        <div style="margin-right:0px;">
        	<input type="text" id="pageNumInput" style="width:50px;margin-left:850px;" oninput = "value=value.replace(/[^\d]/g,'')"/>
        	<button type="button" class="btn btn-info" id="pageNumSkip" style="margin-left:10px;height:30px;margin-top:-4px;">跳转</button>
        </div>
        <div class="h5">&nbsp;</div>
      </div>
    </div>
